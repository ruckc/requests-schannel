...
ISC_REQ_TLS_CLIENT_MTLS = ISC_REQ_TLS_CLIENT | ISC_REQ_USE_SUPPLIED_CREDS
...
CRYPT_E_REVOCATION_OFFLINE = 0x80092012
...
CRYPT_ACQUIRE_PREFER_NCRYPT_KEY_FLAG = 0x00010000

# --- Key Spec ---
CERT_NCRYPT_KEY_SPEC = 0xFFFFFFFF  # pdwKeySpec value indicating a CNG (NCrypt) key

# --- NCrypt property name for parent window handle ---
NCRYPT_WINDOW_HANDLE_PROPERTY = "UI Window Handle"

# --- PP_CLIENT_HWND: CryptSetProvParam parameter for CAPI parent window ---
PP_CLIENT_HWND = 0x00000065
